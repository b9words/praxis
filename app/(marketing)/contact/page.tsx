        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 relative">
          <div className="max-w-2xl mx-auto">
            <Card className="border-neutral-200 bg-white">
              <CardHeader>
                <CardTitle className="text-2xl font-light text-neutral-900 tracking-tight">Send a Message</CardTitle>
              ...
              <CardContent>
                {submitted ? (
                  <div className="bg-neutral-50 border border-neutral-200 text-neutral-700 px-4 py-3 rounded-none mb-4">
                    <p className="font-medium mb-1 text-neutral-900">Message Sent</p>
