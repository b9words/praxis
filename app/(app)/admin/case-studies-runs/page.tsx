...
export default async function AdminCaseStudyRunsPage({
  searchParams,
}: {
  ...
  // Cache case study runs list queries (2 minutes revalidate)
  const getCachedCaseStudyRuns = cache(
    async () => {
      const where: any = {}
    ...
    ['admin', 'case-studies-runs', userId, caseId, status, page.toString()],
    {
  ...
  const getCachedFilters = cache(
    ...
    ['admin', 'case-studies-runs', 'filters'],
    {
