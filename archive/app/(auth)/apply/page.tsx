                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="motivation">
                      Why do you want to join Execemy Platform? *
                    </Label>
                    <Textarea
                      id="motivation"
                  ...
                  <div className="bg-neutral-100 border border-neutral-200 px-4 py-3 rounded-none">
                    <p className="text-sm text-neutral-700">
                      <strong className="font-medium text-neutral-900">Note:</strong> Execemy Platform maintains a curated community focused on analytical rigor. 
